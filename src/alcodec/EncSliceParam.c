...
int32_t SliceParamToCmdRegsEnc1(char *arg1, int32_t *arg2, void *arg3, ...)
{
    ...
    fprintf(stderr,
            "libimp/SLP: enc1-pack entry sp=%p cmd=%p meta=%p b0=%u b1=%u b2=%u b3=%u b8=%u type=%u dim=%ux%u lcu=%ux%u 7a=%u 7c=%u a8=%u aa=%u ac=%u\n",
            arg1, arg2, arg3,
            (unsigned)READ_U8(arg1, 0), (unsigned)READ_U8(arg1, 1),
            (unsigned)READ_U8(arg1, 2), (unsigned)READ_U8(arg1, 3),
            (unsigned)READ_U8(arg1, 8),
    ...
    slp_kmsg("libimp/SLP: entry sp=%p cmd=%p meta=%p b0=%u b1=%u b2=%u b3=%u b8=%u type=%u dim=%ux%u lcu=%ux%u 7a=%u 7c=%u a8=%u aa=%u ac=%u\n",
             arg1, arg2, arg3,
             (unsigned)READ_U8(arg1, 0), (unsigned)READ_U8(arg1, 1),
             (unsigned)READ_U8(arg1, 2), (unsigned)READ_U8(arg1, 3),
             (unsigned)READ_U8(arg1, 8),
